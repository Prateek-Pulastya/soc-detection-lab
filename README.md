...
Status: ✅ detected on live detonation · 🟡 rule drafted, awaiting detonation · ⬜ not started.

| ATT&CK | Technique | Tactic | Telemetry | Wazuh rule | Status |
|--------|-----------|--------|-----------|-----------|--------|
| [T1059.001](detections/T1059.001/) | PowerShell (encoded / cradle) | Execution | Sysmon EID 1 | 100201 | 🟡 worked example |
...
| [T1003.001](detections/T1003.001/) | LSASS memory dump (**marquee**) | Credential Access | Sysmon EID 10 | 100231 | 🟡 |
| [T1055](detections/T1055/) | Process Injection | Defense Evasion | Sysmon EID 8 / 10 | 100241 | 🟡 |
...
| [T1021.001](detections/T1021.001/) | Remote Desktop | Lateral Movement | 4624 type 10 | 100281 | 🟡 |
